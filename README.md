...
![Big picture](https://ibb.co/q5VSGWB)
...
![Process modeling](https://ibb.co/QP1RKTY)
...
![Software design](https://ibb.co/D8Ls6Z0)
...
![Организация разработки сервиса](https://ibb.co/k3KYzhm)
...
![Сочетание MSA со Scrum](https://ibb.co/JtG53dq)
...
![Аутентификация](https://ibb.co/RzpWWGx)
...
токенов.
![Проверка токена](https://ibb.co/Pw2mBRj)
...
![Разделение ООП/DDD  и CRUD](https://ibb.co/C1Qqjc1)
...
![Предохранитель](https://ibb.co/XjPK8wf)
...
![Transactional outbox pattern и Polling publisher pattern](https://ibb.co/FwZFghn)
...
![Transactional log tailing + Outbox](https://ibb.co/s3vSN8v)
*Transactional inbox*
...
![Пирамида тестирования](https://ibb.co/bvJHtwc)
...
Популярные решения:
PACT.
![PACT](https://ibb.co/yF815JJ)
![Тестирование провайдера](https://ibb.co/6bqVydw)
![Тестирование консюмера](https://ibb.co/NxyWVRN)

*Компонентные тесты*
Направлены на публичные методы сервисов.
![Компонентные тесты](https://ibb.co/1LcQ7rV)

*End-to-end*
Тестирование всего процесса интеграции всех сервисов. Не дают ответ – можно ли релизиться.
Тестируйте маршруты, а не истории.
![E2E](https://ibb.co/2jY83tW)
...
![Виды тестирования](https://ibb.co/D4QqgLB)
...
![Kubernetes](https://ibb.co/r38Gghg)

Grafana
Получает и хранит метрики
![Grafana](https://ibb.co/D186bBq)
...
![Отделение Frontend от Backend](https://ibb.co/zRw0588)
- Постепенные изменения – поочередное вынесение функционала в сервис.
![Разбиение монолита](https://ibb.co/D5CLWBR)
...
![Разбиение монолита путем выделения сервисов](https://ibb.co/gmMzdSg)

*Branch by abstraction pattern*
Создание интерфейса между частями и вынос имплементации в новый мс.
![Branch by abstraction pattern](https://ibb.co/2YGyvzQ)

*Change data capture pattern*
Уйти из монолита, не обладая исходным кодом.
![Change data capture pattern](https://ibb.co/7409cyJ)
...
![Split table pattern](https://ibb.co/rZFH5tM)

Шаги выделения мс из монолита:
- Event Storming;
- Выделяем авторизацию в мс;
![Выделяем авторизацию в мс](https://ibb.co/RvnXTbr)
...
![Перекачка данных на основе событий](https://ibb.co/SvDmwHz)
